    ...
    <div id="mobile-nav-drawer" x-show="mobileOpen" x-cloak
        class="fixed inset-y-0 left-0 z-50 w-72 overflow-y-auto bg-surface shadow-xl lg:hidden"
        ...
        {{-- Drawer header --}}
        <div class="flex items-center justify-between border-b border-soft px-4 py-4">
